Running Locally - Update localRepository path in settings.xml. Repository is already added in Project. User need to update only path after downloading the project.
